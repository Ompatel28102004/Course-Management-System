...
//         try {
//             const newActivity = new Activity({ description, type });
...
//         try {
//             const settings = await Settings.findOne({ username: req.query.username });
//             if (!settings) {
...
//         const { username, emailNotifications, smsNotifications, userRole, deactivateAccount } = req.body;
...
//                 { username },
//                 { emailNotifications, smsNotifications, userRole, deactivateAccount, updatedAt: new Date() },
