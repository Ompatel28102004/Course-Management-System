...
// import { FaChalkboard, FaPlusCircle, FaEye, FaEdit, FaSpinner, FaCheckCircle, FaQuestion, FaUserGraduate, FaChalkboardTeacher, FaUserTie } from 'react-icons/fa';
...
//         { label: 'Inbox', href: '/student/dashboard/inbox', icon: MessageSquare },
...
//         // { label: 'Calendar', href: '/calendar', icon: MdOutlineDashboard }
//       ]
//     },
...
//         { label: 'Manage Classes', href: '/manage-classes' },
...
//     {
//       id: 1, label: 'Dashboard', href: '/dashboard', icon: Columns2, children: [
//         { label: 'Overview', href: '/admin_dashboard' },
//         { label: 'Settings', href: '/settings' }
//       ]
//     },
//     {
...
//   'academic-admin': [
//     {
//       id: 1, label: 'Dashboard', href: '/academic-admin-dashboard', icon: Columns2, children: [
//         { label: 'Overview', href: '/academic-admin-dashboard', icon: MdOutlineDashboard },
//         { label: 'Common Forum', href: '/academic-admin-dashboard/om', icon: FaChalkboard },
//       ]
//     },
//     {
//       id: 2, label: 'User Management', href: '/academic-admin-dashboard/user_management/student', icon: Users, children: [
//         { label: 'Student', href: '/academic-admin-dashboard/user_management/student', icon: FaUserGraduate },
//         { label: 'Faculty', href: '/academic-admin-dashboard/user_management/faculty', icon: FaChalkboardTeacher },
//         { label: 'TAs', href: '/academic-admin-dashboard/user_management/ta', icon: FaUserTie }
//       ]
//     },
//     {
//       id: 3, label: 'Course Management', href: '/academic-admin-dashboard/course_management/viewcourse', icon: BookOpen, children: [
//         { label: 'View Course', href: '/academic-admin-dashboard/course_management/viewcourse', icon: FaEye },
//         { label: 'Add Course', href: '/academic-admin-dashboard/course_management/addcourse', icon: FaPlusCircle }
//       ]
//     },
//     {
//       id: 4, label: 'Feedback', href: '/academic-admin-dashboard/feedback/ongoing', icon: FileText, children: [
//         { label: 'Ongoing Feedback', href: '/academic-admin-dashboard/feedback/ongoing', icon: FaSpinner },
//         { label: 'Add Feedback', href: '/academic-admin-dashboard/feedback/add', icon: FaEdit },
//         { label: 'Completed Feedback', href: '/academic-admin-dashboard/feedback/completed', icon: FaCheckCircle },
//         { label: 'Responsed Feedback', href: '/academic-admin-dashboard/feedback/answer', icon: VscFeedback },
//         { label: 'Questions', href: '/academic-admin-dashboard/feedback/question', icon: FaQuestion },
//       ]
//     }
//   ],
//   'finance-admin': [
...
//                     className="flex items-center justify-between w-full px-4 py-2 text-gray-700 hover:bg-indigo-100 hover:text-indigo-600"
//                   >
...
//                     <div className="absolute bottom-0 left-0 w-full h-0.5 bg-indigo-600 transform origin-left transition-all duration-300 ease-in-out scale-x-100" />
//                   )}
//                 </li>
//               ))}
//             </ul>
    ...
    <div className="flex h-screen bg-gray-50 ">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between bg-white px-4 shadow-sm">
          ...
          <div className="flex items-center space-x-4">
            <button className="text-gray-500 hover:text-indigo-600 transition-colors duration-200" onClick={() => {
